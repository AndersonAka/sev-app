    ...
    <div>
      <div className="relative z-20 rounded-[7px] bg-white dark:bg-dark-2">
        <select
          ...
          className={`relative z-10 w-full appearance-none rounded-[7px] border border-stroke bg-transparent px-11.5 py-3 outline-none transition focus:border-green-600 active:border-green-600 dark:border-dark-3 dark:bg-dark-2 ${isOptionSelected ? "text-dark dark:text-white" : ""
            }`}
        >
